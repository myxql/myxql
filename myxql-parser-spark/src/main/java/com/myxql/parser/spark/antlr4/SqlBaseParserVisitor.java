...
public interface SqlBaseParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code analyzeStatementDefault}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAnalyzeStatementDefault(SqlBaseParser.AnalyzeStatementDefaultContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#capturingIdent}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCapturingIdent(SqlBaseParser.CapturingIdentContext ctx);
	/**
