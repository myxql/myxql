...
public interface SqlBaseParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code analyzeStatementDefault}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 */
	void enterAnalyzeStatementDefault(SqlBaseParser.AnalyzeStatementDefaultContext ctx);
	/**
	 * Exit a parse tree produced by the {@code analyzeStatementDefault}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 */
	void exitAnalyzeStatementDefault(SqlBaseParser.AnalyzeStatementDefaultContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SqlBaseParser#capturingIdent}.
	 * @param ctx the parse tree
	 */
	void enterCapturingIdent(SqlBaseParser.CapturingIdentContext ctx);
	/**
	 * Exit a parse tree produced by {@link SqlBaseParser#capturingIdent}.
	 * @param ctx the parse tree
	 */
	void exitCapturingIdent(SqlBaseParser.CapturingIdentContext ctx);
	/**
